...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  if(HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_3) == GPIO_PIN_SET) {
	    	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_7,GPIO_PIN_SET);//1번
	  	  	Lock_Num1 += 1;
	  }
	  else{
	  ...
	  if(HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_4) == GPIO_PIN_SET) {
	  	  	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_SET);//3번
	  	  	Lock_Num2 += 1;
	  }
	  else{
	  ...
	  if(HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_5) == GPIO_PIN_SET) {
	  	  	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,GPIO_PIN_SET);//1번
	  	  	Lock_Num3 += 1;
	  }
	  else{
